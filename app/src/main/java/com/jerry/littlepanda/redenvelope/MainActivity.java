...
import com.jerry.littlepanda.mytool.DeviceInfoActivity;
import com.jerry.littlepanda.redenvelope.job.WechatAccessbilityJob;
import com.jerry.littlepanda.redenvelope.util.BitmapUtils;
...
public class MainActivity extends BaseSettingsActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        APPAplication.activityStartMain(this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case 0:
                ...
                APPAplication.eventStatistics(this, "menu_service");
                return true;
            case 3:
                openNotificationServiceSettings();
                APPAplication.eventStatistics(this, "menu_notify");
                break;
            case 4:
                startActivity(new Intent(this, AboutMeActivity.class));
                APPAplication.eventStatistics(this, "menu_about");
                break;
        }
    ...
    private void showAgreementDialog() {
        ...
        builder.setPositiveButton("同意", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                APPAplication.eventStatistics(MainActivity.this, "agreement", "true");
            }
        });
        builder.setNegativeButton("不同意", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                APPAplication.eventStatistics(MainActivity.this, "agreement", "false");
                finish();
            }
        });
        builder.show();
    ...
    private void showQrDialog() {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                APPAplication.eventStatistics(MainActivity.this, "copy_qr");
                dialog.dismiss();
            }
        });
    ...
    public static class MainFragment extends BaseSettingsFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            notificationPref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    APPAplication.eventStatistics(getActivity(), "notify_service", String.valueOf(newValue));
                    return true;
                }
            });
            ...
            if(preference != null) {
                preference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                    ...
                    public boolean onPreferenceClick(Preference preference) {
                        ...
                        APPAplication.eventStatistics(getActivity(), "about_author");
                        return true;
                    }
                });
            }
            ...
            if(preference != null) {
                preference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                    ...
                    public boolean onPreferenceClick(Preference preference) {
                        ...
                        APPAplication.eventStatistics(getActivity(), "donate");
                        return true;
                    }
                });
            }
        ...
        public void updateNotifyPreference() {
            ...
            if( enable && running && !notificationPref.isChecked()) {
                APPAplication.eventStatistics(getActivity(), "notify_service", String.valueOf(true));
     ...
     * @param mActivity
     */
    public static void jumpToRebPackageMainActivity(Activity mActivity)
    {
