        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            wxMode.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    APPAplication.eventStatistics(getActivity(), "wx_mode", String.valueOf(newValue));
                    return true;
                }
            });
            ...
            wxAfterOpenPre.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    APPAplication.eventStatistics(getActivity(), "wx_after_open", String.valueOf(newValue));
                    return true;
                }
            });
            ...
            wxAfterGetPre.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    APPAplication.eventStatistics(getActivity(), "wx_after_get", String.valueOf(newValue));
                    return true;
                }
            });
            ...
            delayEditTextPre.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    APPAplication.eventStatistics(getActivity(), "wx_delay_time", String.valueOf(newValue));
                    return true;
                }
            });
